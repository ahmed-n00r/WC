...
<body>
	...
	<div class="container-w3">
		...
		<div><div id="myDIV" class="header">
		  <h2 style="margin:5px">My To Do List</h2>
		  <input type="text" id="myInput1" style="width: 50%;"><input type="text" id="myInput2"style="width: 25%;" >
		...
		function newElement() {
		  ...
		  var t = document.createTextNode(inputValue2+" : "+inputValue);
		  li.appendChild(t);
		  if (inputValue === '') {
